...
public class DiagrammBody {
  ...
  public String getAsHTML() {
    ...
    _builder.newLine();
    _builder.append("                            ");
    _builder.append("{ routing: go.Link.AvoidsNodes,");
    _builder.newLine();
    _builder.append("                                ");
    _builder.append("curve: go.Link.JumpGap");
    _builder.newLine();
    _builder.append("                            ");
    _builder.append("},");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("                            ");
    _builder.append("$(go.TextBlock, { segmentIndex: 0, segmentFraction: 0.4 },");
    _builder.newLine();
    _builder.append("                                ");
    _builder.append("new go.Binding(\"text\", \"sourceRole\")),");
    _builder.newLine();
    _builder.append("                            ");
    _builder.append("$(go.TextBlock, { segmentIndex: 3, segmentFraction: 0.6 },");
    _builder.newLine();
    _builder.append("                                ");
    _builder.append("new go.Binding(\"text\", \"targetRole\"))");
    _builder.newLine();
    _builder.append("                    ");
    _builder.append(");");
    _builder.newLine();
