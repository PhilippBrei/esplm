		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getActivityAccess().getPredecessorAssignment_5(), "rule__Activity__PredecessorAssignment_5");
					put(grammarAccess.getActivityAccess().getPredecessorAssignment_6_1(), "rule__Activity__PredecessorAssignment_6_1");
					put(grammarAccess.getActivityAccess().getSucessorsAssignment_10(), "rule__Activity__SucessorsAssignment_10");
					put(grammarAccess.getActivityAccess().getSucessorsAssignment_11_1(), "rule__Activity__SucessorsAssignment_11_1");
					put(grammarAccess.getActivityAccess().getDescriptionAssignment_14(), "rule__Activity__DescriptionAssignment_14");
