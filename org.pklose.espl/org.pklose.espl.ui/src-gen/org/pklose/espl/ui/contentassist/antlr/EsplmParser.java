		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getActivityDiagramAccess().getImportsAssignment_0(), "rule__ActivityDiagram__ImportsAssignment_0");
					put(grammarAccess.getActivityDiagramAccess().getNameAssignment_2(), "rule__ActivityDiagram__NameAssignment_2");
					put(grammarAccess.getActivityDiagramAccess().getActivitiesAssignment_4(), "rule__ActivityDiagram__ActivitiesAssignment_4");
					put(grammarAccess.getActivityAccess().getNameAssignment_1(), "rule__Activity__NameAssignment_1");
					put(grammarAccess.getActivityAccess().getPredecessorAssignment_3_2(), "rule__Activity__PredecessorAssignment_3_2");
					put(grammarAccess.getActivityAccess().getPredecessorAssignment_3_3_1(), "rule__Activity__PredecessorAssignment_3_3_1");
					put(grammarAccess.getActivityAccess().getSucessorsAssignment_4_2(), "rule__Activity__SucessorsAssignment_4_2");
					put(grammarAccess.getActivityAccess().getSucessorsAssignment_4_3_1(), "rule__Activity__SucessorsAssignment_4_3_1");
					put(grammarAccess.getActivityAccess().getBusinessRuleAssignment_5_1(), "rule__Activity__BusinessRuleAssignment_5_1");
					put(grammarAccess.getActivityAccess().getDescriptionAssignment_7(), "rule__Activity__DescriptionAssignment_7");
